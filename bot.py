...
parameters = {"slug": "filecoin", "convert": "USD"}
...
# a = pprint.pprint(json.loads(response.text)["data"]["2280"]["quote"]["USD"]["price"])
price = str(json.loads(response.text)["data"]["2280"]["quote"]["USD"]["price"])
